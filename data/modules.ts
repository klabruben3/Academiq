...
export const MODULES: Module[] = [
  {
    ...
    description:
      "Develops calculus, sequences and series, mathematical modelling, and analytical problem-solving for engineering and science students.",
    addedYear: 2026,
    color: "#6366f1",
  ...
  },
  {
    ...
    description:
      'Introduces vector algebra, mathematical modelling, interpolation, curve fitting, and numerical methods for real-world engineering applications.',
    addedYear: 2026,
    color: "#10b981",
    lecturer: "Dr Hitge",
  ...
  },
  {
    ...
    description:
      "Covers the fundamentals of probability theory, random variables, distributions, and statistical reasoning for scientific applications.",
    addedYear: 2026,
    color: "#f59e0b",
  ...
  },
  {
    ...
    description:
      "Develops academic writing, digital literacy, AI ethics, critical thinking, and communication skills for university study.",
    addedYear: 2026,
    color: "#ec4899",
